	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
            ...
            <div class="social-wrapper">
                ...
                <?php echo file_get_contents('http://localhost:8888/leading-minds/wp-content/themes/leading_minds/imgs/twitter-logo.svg'); ?>
                <?php echo file_get_contents('http://localhost:8888/leading-minds/wp-content/themes/leading_minds/imgs/linkedin-logo.svg'); ?>
                <?php echo file_get_contents('http://localhost:8888/leading-minds/wp-content/themes/leading_minds/imgs/bbb-logo.svg'); ?>
                <?php echo file_get_contents('http://localhost:8888/leading-minds/wp-content/themes/leading_minds/imgs/pcc-logo.svg'); ?>
            </div>
